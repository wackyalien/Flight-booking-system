...
import com.micro.checkin.models.ApiErrors;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler{
    ...
    @ExceptionHandler(AlreadyCheckInException.class)
    public ResponseEntity<Object> handleIdNotFoundException(AlreadyCheckInException ex){
        String message = ex.getMessage();
        List<String> details= new ArrayList<>();
        details.add("User already checkedIn");
